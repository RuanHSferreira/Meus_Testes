...
from CentraLibrary import *
from buttonFunction import *
from messageHandling import ABC
...
def recebendo(msg):
    ...
    if 'new_chat_member' in msg:
        ...
        if limpesa == 'hall menu' or limpesa == 'menu hall':
        ...
        elif limpesa == 'hall aviso ao grupo':
            ...
            with open('centralMessages.txt', 'r', encoding='utf-8') as file:
                ...
                if limpesa in file.read():
                    ...
                    bot.sendMessage(chatID, 'Não Entendi sua pergunta,tente novamente com outras palavras ou diga hall google ou hall wikipedia ')
                    message_count(name)
